<template>
  <div :class="[`yk-checkbox-${size}`, customClass]">
    <label
      v-for="(item, index) in checkOptions"
      :key="index"
      class="yk-checkbox-label"
      :class="[
        { 'yk-checkbox-label-active': item.checked },
        item.checked
          ? item.disabled
            ? 'yk-checkbox-label-active-disabled'
            : ''
          : item.disabled
          ? 'yk-checkbox-label-disabled'
          : '',
      ]"
